...
namespace Flyturismo.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(TurismoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Destino,Cidade,Pais")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Destino,Cidade,Pais")] Destino destino)
        {
